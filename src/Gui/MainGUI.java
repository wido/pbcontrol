...
public class MainGUI extends JApplet implements ActionListener {
    ...
    /* Tabs */
    private JPanel mainTab, diagTab, logTab;
    ...
    private JButton startButton, stopButton, resetButton, freezeButton, reverseButton;

    private JComboBox flagAction;

    private JSpinner respawnTimeSpinner, gameTimeSpinner;
